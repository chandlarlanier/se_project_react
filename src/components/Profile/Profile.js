...
const Profile = ({ onSelectCard, handleOpenModal, clothingItems, handleSignOut, isLoggedIn, handleLikeButton }) => {
  ...
  return (
    <div className="profile__container">
      ...
      <ClothesSection onSelectCard={onSelectCard} handleOpenModal={handleOpenModal} clothingItems={ownerClothingItems} handleLikeButton={handleLikeButton} isLoggedIn={isLoggedIn}/>
    </div>
  );
};
